	...
	const services = [
		{
			...
			title: 'Find  Doctor',
			description:
				'Easily locate trusted and  doctors in your area. This service ensures you connect with qualified professionals for your healthcare needs. Save time and gain peace of mind with reliable doctor recommendations.',
			icon: <UserCheck />,
