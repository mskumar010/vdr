	...
	<footer className="footer">
		<div className="footer__content">
			<div className="footer__col">
				...
				<p className="footer__description">
					Your trusted health companion, connecting you with ,
			...
			<div className="footer__col">
				...
				<p>
					Email: <a href="mailto:support@vhc.health">support@vhc.health</a>
				</p>
				<p>
		...
		<div className="footer__bottom">
			<p className="footerCopyright">
				&copy; {new Date().getFullYear()} Hiscope Enterprises. All rights
				reserved.
			</p>
